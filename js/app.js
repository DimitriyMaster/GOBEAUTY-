(() => {
    ...
    function initSliders() {
        const sliderSections = document.querySelectorAll(".location-preview");
        if (sliderSections.length > 0) sliderSections.forEach(section => {
            const mainContainer = section.querySelector(".location-preview-main__slider");
            const thumbsContainer = section.querySelector(".location-preview-thumbs__slider");
            const prevBtn = section.querySelector(".swiper-button-prev");
            const nextBtn = section.querySelector(".swiper-button-next");
            if (mainContainer && thumbsContainer) {
                const thumbsSwiper = new swiper_core_Swiper(thumbsContainer, {
                    slidesPerView: 4,
                    spaceBetween: 10,
                    freeMode: true,
                    watchSlidesProgress: true,
                ...
                new swiper_core_Swiper(mainContainer, {
